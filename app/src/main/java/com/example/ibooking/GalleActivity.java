...
public class GalleActivity extends AppCompatActivity implements View.OnClickListener {
 Button btn1,btn2,btn3,btn4,btn5,btn6;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case button1:{
                intent=new Intent(getApplicationContext(),YaragalleActivity.class);
                break;
            }
            case button2:{
                intent=new Intent(getApplicationContext(),GalleFortActivity.class);
                break;
            }
            case button3:{
                intent=new Intent(getApplicationContext(),AmariHotelActivity.class);
                break;
            }
            case button4:{
                intent=new Intent(getApplicationContext(),CityStayActivity.class);
                break;
            }
            case button5:{
                intent=new Intent(getApplicationContext(),GrennCasaActivity.class);
                break;
            }
            case button6:{
                intent=new Intent(getApplicationContext(),JetwinActivity.class);
                break;
            }
        }
        assert intent != null;
