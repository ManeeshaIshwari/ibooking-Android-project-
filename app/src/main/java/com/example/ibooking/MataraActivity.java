...
public class MataraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case button1:{
                intent=new Intent(getApplicationContext(),NildiyaActivity.class);
                break;
            }
            case button2:{
                intent=new Intent(getApplicationContext(),TopsecreActivity.class);
                break;
            }
            case button3:{
                intent=new Intent(getApplicationContext(),GrandRockActivity.class);
                break;
            }
            case button4:{
                intent=new Intent(getApplicationContext(),ScapeActivity.class);
                break;
            }
            case button5:{
                intent=new Intent(getApplicationContext(),CultureActivity.class);
                break;
            }
            case button6:{
                intent=new Intent(getApplicationContext(),OnaraActivity.class);
                break;
            }
        }
        assert intent != null;
